...
-include src/SPL06_007/subdir.mk
-include src/buzzer/subdir.mk
-include src/gpio_uart/subdir.mk
-include src/hdc2080/subdir.mk
-include src/key/subdir.mk
-include src/lvgl_ui/subdir.mk
-include src/other/subdir.mk
-include src/relay/subdir.mk
-include src/tsl2561fn/subdir.mk
...
OUT_ELF=project1.exe
OUT_MAP=project1.map
OUT_BIN=project1.bin
...
$(OUT_ELF): $(STARTO) $(OBJS) $(USER_OBJS)
	...
	D:/LoongIDE/mips-2011.03/bin/mips-sde-elf-gcc.exe  -mips32 -G0 -EL -msoft-float -nostartfiles -static -T $(LINKCMDS) -o $(OUT_ELF) -e start $(STARTO) $(OBJS) $(USER_OBJS) $(LIBS) -L"$(GCC_SPECS)/$(OS)" 
