define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'equipment/maintenance/index' + location.search,
                    add_url: 'equipment/maintenance/add',
                    table: 'equipment_maintenance',
                    deactivated_url: 'equipment/maintenance/deactivated',
                }
            });
                    ...
                    [
                            ...
                            field: 'plan_fields', title: __('FieldName'), operate: false, table: table, buttons: [
                                {
                                    name: 'fields',
                                    text: function (row) {
                                        return row.plan_fields.length + ' 个保养项';
                                    },
                                    title: __('FieldName'),
                        ...
                        {field: 'operate', title: __('Operate'), table: table,
                            buttons: [
                                ...
                                {
                                    name: 'list',
                                    text: __('Maintenance record details'),
                                    title: __('Maintenance record details'),
                                    extend: 'data-area=\'["900px", "600px"]\'',
                                    classname: 'btn btn-xs btn-primary btn-dialog',
                                    url: 'equipment/record/list?type=maintenance'
                                }
                            ],
            ...
            $(document).on("click", ".btn-deactivated", function () {
                Fast.api.open('equipment/maintenance/deactivated', __('Deactivated'), {
                    area: ["100%", "100%"],
                });
            });
        ...
        deactivated: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'equipment/maintenance/deactivated' + location.search,
                    table: 'equipment_maintenance',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'equipment/maintenance/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'equipment/maintenance/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'equipment/maintenance/destroy',
                                    refresh: true
                                }
                            ],
        ...
        add: function () {
            ...
            function deleteField(row, data) {
                Layer.confirm(
                    __('This operation will delete the maintenance item, whether to continue?'),
