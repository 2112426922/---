define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'equipment/message/index' + location.search,
                    add_url: 'equipment/message/add',
                    edit_url: 'equipment/message/edit',
                    del_url: 'equipment/message/del',
                    multi_url: 'equipment/message/multi',
                    import_url: 'equipment/message/import',
                    table: 'equipment_message',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        formatter: function (value, row, index) {
                            return "<span class='text-danger'>" + value + "层</span>";
                        }, operate: false},
                        {field: 'x', title: __('X'),
                        formatter: function (value, row, index) {
                            return "<span class='text-danger'>" + value + "m</span>";
                        }, operate: false},
                        {field: 'y', title: __('Y'),
                        formatter: function (value, row, index) {
                            return "<span class='text-danger'>" + value + "m</span>";
        ...
        edit: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'equipment/message/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
