...
//            static::$pidFile = __DIR__ . "/../$unique_prefix.pid";
            static::$pidFile = __DIR__ . "/../../../../../../../../runtime/addon_notice/$unique_prefix.pid";
        }

        // Log file.
        if (empty(static::$logFile)) {
            static::$logFile = __DIR__ . '/../../../../../../../../runtime/addon_notice/workerman.log';
//            static::$logFile = __DIR__ . '/../workerman.log';
        }
        $log_file = (string)static::$logFile;
        if (!is_dir( __DIR__ . "/../../../../../../../../runtime/addon_notice")) {
            mkdir(__DIR__ . "/../../../../../../../../runtime/addon_notice");
        }
        if (!\is_file($log_file)) {
            \touch($log_file);
            \chmod($log_file, 0622);
